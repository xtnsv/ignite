...
public class IgniteStandardMXBeanTest {
     ...
     */
    @Test
    public void getDescription_OldAnnotationEmptyParamValue() {
        assertThrows(AssertionError.class,
     ...
     */
    @Test
    public void getDescription_OldAnnotationNoDotAtTheEndOfTheString() {
        assertThrows(AssertionError.class,
     ...
     */
    @Test
    public void getDescription_OldAnnotationFirstLowercaseLetter() {
        assertThrows(AssertionError.class,
     ...
     */
    @Test
    public void getDescription_NewAnnotationFirstLowercaseLetter() {
        assertThrows(AssertionError.class,
